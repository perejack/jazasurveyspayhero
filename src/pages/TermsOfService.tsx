  ...
  const sections = [
    {
      ...
      content: `By accessing or using the Jaza platform ("Platform"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, you may not use our services.
      ...
      You must be at least 18 years old and a resident of Kenya to use this Platform. By using Jaza, you represent and warrant that you meet these eligibility requirements.`
    },
    {
      icon: FileText,
      title: "Account Registration & Security",
      content: `To use Jaza, you must create an account. You agree to:
    ...
    },
    {
      ...
      is the property of Jaza or its licensors and is protected by copyright, trademark, and other intellectual property laws.
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-lg mx-auto">
            Please read these terms carefully before using the Jaza platform.
          </p>
        ...
        >
          <p className="text-muted-foreground leading-relaxed mb-4">
            Welcome to Jaza! These Terms of Service (&quot;Terms&quot;) govern your use of our website, mobile applications, and related services (collectively, the &quot;Platform&quot;) operated by Jaza Technologies Ltd (&quot;Jaza,&quot; &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;).
          </p>
          <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        >
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            TO THE MAXIMUM EXTENT PERMITTED BY LAW, JAZA SHALL NOT BE LIABLE FOR:
          </p>
