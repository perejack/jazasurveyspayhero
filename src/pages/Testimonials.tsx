  ...
  const featuredStories = [
    {
      ...
      quote: "Jaza helped me cover my transport and lunch expenses while studying. The surveys are quick and I can do them between classes. It's the easiest money I've ever made!",
      rating: 5,
    ...
    },
    {
      ...
      quote: "Being at home with kids, I needed something flexible. Jaza lets me earn while the kids nap. The surveys about parenting products are actually interesting!",
      rating: 5,
      ...
      <div className="container mx-auto px-4 py-12 max-w-5xl">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
            Join thousands of Kenyans who are already earning with Jaza. Real people, real earnings, real impact.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-primary-foreground/80 mb-6 max-w-lg mx-auto">
            Join 50,000+ Kenyans already earning with Jaza. Create your free account and start your journey today.
          </p>
