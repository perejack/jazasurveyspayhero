...
const Blog = () => {
  ...
  const posts = [
    ...
    },
    {
      ...
      excerpt: "Protect yourself from fraudulent survey sites. Learn the red flags that indicate a scam and how to identify legitimate platforms like Jaza.",
      author: "Jaza Security Team",
      date: "January 5, 2026",
      readTime: "5 min read",
      category: "Safety",
