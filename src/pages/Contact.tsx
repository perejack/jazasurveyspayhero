  ...
  const contactInfo = [
    {
      icon: Mail,
      title: "Email Us",
      details: ["support@jaza.co.ke", "business@jaza.co.ke"],
    ...
    },
    {
      icon: MapPin,
      title: "Visit Us",
      details: ["Jaza Technologies Ltd", "Nairobi, Kenya"],
          ...
          >
            ...
            <div className="mt-8 bg-primary/5 rounded-2xl p-6">
              ...
              <div className="space-y-2 text-sm">
                ...
                <p className="text-muted-foreground">
                  • Having technical issues? Email <a href="mailto:support@jaza.co.ke" className="text-primary hover:underline">support@jaza.co.ke</a>
                </p>
                <p className="text-muted-foreground">
                  • Business inquiries? Contact <a href="mailto:business@jaza.co.ke" className="text-primary hover:underline">business@jaza.co.ke</a>
                </p>
              </div>
            </div>
          </motion.div>
