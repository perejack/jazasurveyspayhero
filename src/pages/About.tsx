      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        >
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            Jaza was founded in 2025 with a simple mission: create a platform where Kenyans can earn real money by sharing their valuable opinions with brands and organizations that need them.
          </p>
          <p className="text-muted-foreground leading-relaxed mb-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Today, Jaza has grown into one of Kenya&apos;s most trusted survey platforms, connecting thousands of users with earning opportunities while helping businesses make data-driven decisions.
          </p>
        </motion.div>
        ...
        >
          Jaza Technologies Ltd • Nairobi, Kenya • © 2026
        </motion.p>
      </div>
    </div>
  );
