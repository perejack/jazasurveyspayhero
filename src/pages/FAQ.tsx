  ...
  const faqCategories = [
    {
      ...
      questions: [
        {
          q: "What is Jaza and how does it work?",
          a: "Jaza is a premium survey platform that connects Kenyan consumers with brands and organizations seeking feedback. You create a free account, complete your profile, and we match you with relevant surveys. Each completed survey earns you rewards that can be withdrawn directly to your M-Pesa. The process is simple: sign up → complete surveys → earn rewards → withdraw to M-Pesa."
        },
        {
          q: "Is Jaza free to join?",
        ...
        {
          q: "Who can join Jaza?",
          a: "Jaza is currently available to residents of Kenya who are 18 years or older. You need a valid Kenyan phone number for M-Pesa withdrawals and an active email address. We're working on expanding to other African countries soon."
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: "Jaza does not charge any withdrawal fees. However, standard M-Pesa transaction fees apply as per Safaricom's rates. These fees are deducted from the withdrawn amount. We recommend withdrawing larger amounts less frequently to minimize transaction costs."
        },
        {
      ...
      questions: [
        {
          ...
          a: "Absolutely. We use bank-level SSL encryption to protect your data. Your personal information is never sold to third parties. Survey responses are anonymized and aggregated before sharing with clients. We comply with Kenya's Data Protection Act, 2019 and international privacy standards."
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: "Check if Jaza is down for maintenance (check our social media for updates). If it's just you: (1) Test your internet connection, (2) Try accessing from a different device, (3) Check if your ISP is blocking the site, (4) Disable VPN if using one. Contact support if issues continue."
        },
        {
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-lg mx-auto">
            Find answers to common questions about using Jaza. Can't find what you're looking for? Contact our support team.
          </p>
        </motion.div>
